...
const meta = securitySubpageMeta.aiGovernance;
...
export default function SecurityAiGovernancePage() {
  return (
    <SecurityPageShell pageId="ai-governance">
      <SecurityTopicContent pageId="ai-governance" />
    </SecurityPageShell>
  );
}
