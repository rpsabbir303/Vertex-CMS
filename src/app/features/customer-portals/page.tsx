...
import { CustomerPortalsFeatureDetailPage } from "@/components/marketing/features/CustomerPortalsFeatureDetailPage";
import { customerPortalsFeatureDetail } from "@/lib/marketing/features/customerPortalsDetail";

const { meta } = customerPortalsFeatureDetail;
    ...
    <MarketingProviders>
      <div className="flex min-h-screen flex-col overflow-x-hidden bg-white text-brand-navy">
        ...
        <main className="w-full min-w-0 flex-1">
          <CustomerPortalsFeatureDetailPage />
        </main>
        <MarketingFooter />
        <CookieConsent />
      </div>
