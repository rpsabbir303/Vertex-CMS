...
import { MobileSafetyUI } from "@/components/mockups/ProductMockups";
...
function SafetyStickyNav() {
  const items = safetyFeatureDetail.nav;
...
export function SafetyFeatureDetailPage() {
  const d = safetyFeatureDetail;
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-brand-line/70 bg-[#F7F9FC]">
        ...
        <div className="site-shell relative py-14 sm:py-16 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
            ...
            <Reveal delay={90}>
              <PreviewStage preview={d.hero.preview} label="Safety overview · Riverside" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="safety-overview" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <Reveal delay={60}>
              ...
              <div className="mt-8">
                <PreviewStage preview={d.howItWorks.preview} label="Follow-up actions" />
              </div>
            </Reveal>
          </div>
        </div>
      ...
      {/* Section 2 — Outcomes */}
      <section id="safety-outcomes" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
      ...
      <section id="safety-activity" className="scroll-mt-28 border-b border-brand-line bg-brand-navy">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.dashboard.preview} label="Safety activity" />
            </Reveal>
          </div>
        </div>
      </section>

      {/* Section 4 — Field alternating */}
      <section id="safety-field" className="scroll-mt-28 border-b border-brand-line bg-white">
      ...
      {/* Section 5 — Follow-up */}
      <section id="safety-followup" className="scroll-mt-28 border-b border-brand-line bg-[#EEF2F7]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
              {d.followUp.headline}
            </h2>
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.followUp.body}</p>
          </Reveal>
          <ol className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {d.followUp.steps.map((step) => (
          ...
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.followUp.preview} label="Observation → resolution" />
          </Reveal>
        </div>
      </section>

      {/* Section 6 — Connected */}
      <section id="safety-workflows" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
      ...
      <section className="border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.visibility.preview} label="What needs attention" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="safety-explore" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
