...
import { MobileTmUI } from "@/components/mockups/ProductMockups";
import { tmFeatureDetail } from "@/lib/marketing/features/tmDetail";
...
function TmStickyNav() {
  const items = tmFeatureDetail.nav;
...
export function TmFeatureDetailPage() {
  const d = tmFeatureDetail;
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-brand-line/70 bg-[#F7F9FC]">
        ...
        <div className="site-shell relative py-14 sm:py-16 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
            ...
            <Reveal delay={90}>
              <PreviewStage preview={d.hero.preview} label="T&M Ticket · TM-218" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="tm-overview" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <Reveal delay={60}>
              ...
              <div className="mt-8">
                <PreviewStage preview={d.howItWorks.preview} label="Ticket detail" dark />
              </div>
            </Reveal>
          </div>
        </div>
      ...
      {/* Section 2 — Outcomes */}
      <section id="tm-outcomes" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
      ...
      {/* Section 3 — Dark activity */}
      <section id="tm-activity" className="scroll-mt-28 border-b border-brand-line bg-brand-navy">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.dashboard.preview} label="Field T&M activity" dark />
            </Reveal>
          </div>
        </div>
      </section>

      {/* Section 4 — Capture alternating */}
      <section id="tm-capture" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing space-y-16 sm:space-y-20">
          {d.fieldBlocks.map((block) => (
            <div key={block.headline} className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
              <Reveal className={block.reverse ? "lg:order-2" : undefined}>
                <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
                  {block.headline}
                </h2>
                <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{block.body}</p>
              </Reveal>
              <Reveal delay={80} className={block.reverse ? "lg:order-1" : undefined}>
      ...
      {/* Section 5 — Review */}
      <section id="tm-review" className="scroll-mt-28 border-b border-brand-line bg-[#EEF2F7]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
              {d.review.headline}
            </h2>
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.review.body}</p>
          </Reveal>
          <ol className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {d.review.steps.map((step) => (
          ...
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.review.preview} label="T&M review queue" />
          </Reveal>
        </div>
      </section>

      {/* Section 6 — Connected */}
      <section id="tm-workflows" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
      ...
      <section className="border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.visibility.preview} label="Labor · materials · equipment" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Section 9 — Explore FO */}
      <section id="tm-explore" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
