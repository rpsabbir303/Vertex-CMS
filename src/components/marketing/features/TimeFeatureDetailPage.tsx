...
import { TimeMobileEntryUI } from "@/components/mockups/ProductMockups";
import { timeFeatureDetail } from "@/lib/marketing/features/timeDetail";
...
function TimeStickyNav() {
  const items = timeFeatureDetail.nav;
...
export function TimeFeatureDetailPage() {
  const d = timeFeatureDetail;
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-brand-line/70 bg-[#F7F9FC]">
        ...
        <div className="site-shell relative py-14 sm:py-16 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
            ...
            <Reveal delay={90}>
              <PreviewStage preview={d.hero.preview} label="Time & labor dashboard" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Time at a glance */}
      <section id="time-overview" className="scroll-mt-28 border-b border-brand-line bg-white">
      ...
      {/* Weekly timesheet */}
      <section id="time-weekly" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
              {d.weekly.headline}
            </h2>
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.weekly.body}</p>
          </Reveal>
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.weekly.preview} label="Weekly timesheet" />
          </Reveal>
        </div>
      </section>
        ...
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.entry.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.entry.preview} label="Time entry" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Labor breakdown */}
      <section id="time-breakdown" className="scroll-mt-28 border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            <Reveal>
              ...
              <h2 className="display-title-light mt-3 text-3xl sm:text-4xl">{d.breakdown.headline}</h2>
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-slate-300">{d.breakdown.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.breakdown.preview} label="Labor breakdown" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Project labor */}
      <section id="time-projects" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal delay={80} className="lg:order-1">
              <PreviewStage preview={d.projectLabor.preview} label="Project labor" />
            </Reveal>
      ...
      {/* Cost codes */}
      <section id="time-costcodes" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.costCode.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.costCode.preview} label="Cost code labor" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Workflow */}
      <section id="time-workflow" className="scroll-mt-28 border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <h2 className="display-title-light text-3xl sm:text-4xl">{d.workflow.headline}</h2>
            <p className="mt-4 text-[15px] leading-relaxed text-slate-300">{d.workflow.body}</p>
          </Reveal>
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.workflow.preview} label="Timesheet workflow" dark />
          </Reveal>
        </div>
      </section>
        ...
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.approval.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.approval.preview} label="Approval queue" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            <Reveal>
              <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
                {d.costConnection.eyebrow}
              </p>
              <h2 className="display-title-light mt-3 text-3xl sm:text-4xl">{d.costConnection.headline}</h2>
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-slate-300">{d.costConnection.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.costConnection.preview} label="Approved labor to cost" dark />
            </Reveal>
          </div>
        </div>
      </section>
        ...
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.payroll.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.payroll.preview} label="Payroll time summary" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal delay={80} className="lg:order-1">
              <PreviewStage preview={d.mobile.preview} label="Field time entry" />
            </Reveal>
            <Reveal className="lg:order-2">
              <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
                {d.mobile.headline}
              </h2>
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.mobile.body}</p>
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Time summary */}
      <section id="time-summary" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
              {d.summary.headline}
          ...
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.summary.preview} label="Labor summary" />
          </Reveal>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.process.body}</p>
          </Reveal>
      ...
      {/* Explore CW */}
      <section id="time-explore" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
              {d.explore.eyebrow}
