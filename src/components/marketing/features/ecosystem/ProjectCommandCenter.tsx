...
export function ProjectCommandCenter({ section }: { section: HubModuleSection }) {
  ...
  return (
    <section
      ...
      data-design-layer="ProjectCommandCenter"
    >
      <div
        ...
        aria-hidden="true"
      />
      <GridWash variant="workspace" />

      <div className={"feat-shell relative " + ECOSYSTEM_BAND}>
        <SectionIntro section={section} />

        <div className="relative mt-8 min-w-0">
          <ProjectCommandWorkspace area={active} areas={section.areas} onSelect={select} />
        </div>
