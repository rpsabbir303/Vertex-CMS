...
import { FinancialControlWorkspace } from "./FinancialControlWorkspace";

export function FinancialControlCenter({ section }: { section: HubModuleSection }) {
  ...
  return (
    <section
      ...
      data-design-layer="FinancialControlCenter"
    >
      <div
        ...
        aria-hidden="true"
      />
      <GridWash variant="ledger" />

      <div className={"feat-shell relative " + ECOSYSTEM_BAND}>
        <SectionIntro section={section} />

        <div className="relative mt-8 min-w-0">
          <FinancialControlWorkspace area={active} areas={section.areas} onSelect={select} />
        </div>
