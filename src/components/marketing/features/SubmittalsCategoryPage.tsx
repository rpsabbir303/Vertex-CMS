...
import { submittalCategory } from "@/lib/marketing/features/submittalCategory";
...
export function SubmittalsCategoryPage() {
  const d = submittalCategory;
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-brand-line/70 bg-[#F7F9FC]">
        ...
        <div className="site-shell relative py-14 sm:py-16 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
            ...
            <Reveal delay={90}>
              <PreviewStage preview={d.hero.preview} label="Submittal Register" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.intro.preview} label="Create to track" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* 3. Register — dark */}
      <section id="submittal-register" className="scroll-mt-28 border-b border-brand-line bg-brand-navy">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
      ...
      {/* 4. Create */}
      <section id="submittal-create" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal delay={80} className="lg:order-1">
              <PreviewStage preview={d.create.preview} label="Create Submittal" />
            </Reveal>
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              ...
              <div className="mt-6 rounded-xl border border-brand-orange/35 bg-brand-orange/10 px-4 py-3">
                <p className="text-[13px] font-semibold text-brand-orange">{d.detail.callout}</p>
              </div>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.detail.preview} label="Submittal detail" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* 6. Review */}
      <section id="submittal-review" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.review.preview} label="Submittal review" />
            </Reveal>
          </div>
        </div>
      </section>
        ...
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-slate-300">{d.workflow.supporting}</p>
              <ol className="mt-6 space-y-2">
                {d.workflow.steps.map((step, index) => (
                  <li key={step} className="flex items-center gap-3 text-[13px] text-slate-200">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.workflow.preview} label="Review workflow" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal delay={80} className="lg:order-1">
              <PreviewStage preview={d.documents.preview} label="Connected documents" />
            </Reveal>
            <Reveal className="lg:order-2">
              <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
                {d.documents.eyebrow}
