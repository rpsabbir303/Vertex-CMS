...
function SubcontractorsStickyNav() {
  const items = subcontractorsFeatureDetail.nav;
  ...
  return (
    <nav
      aria-label="Subcontractors sections"
...
export function SubcontractorsFeatureDetailPage() {
  const d = subcontractorsFeatureDetail;
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-brand-line/70 bg-[#F7F9FC]">
        ...
        <div className="site-shell relative py-14 sm:py-16 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
            ...
            <Reveal delay={90}>
              <PreviewStage preview={d.hero.preview} label="Subcontractor workspace" />
            </Reveal>
          </div>
        </div>
      </section>

      <SubcontractorsStickyNav />

      {/* Directory */}
      <section id="sub-directory" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <Reveal className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.directory.body}</p>
          </Reveal>
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.directory.preview} label="Subcontractor directory" />
          </Reveal>
        </div>
      </section>

      {/* Profile */}
      <section id="sub-profile" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.profile.preview} label="Subcontractor detail" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="sub-readiness" className="scroll-mt-28 border-b border-brand-line bg-[#F4F7FB]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.95fr)_minmax(0,1.05fr)] lg:gap-14">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.readiness.body}</p>
              <ul className="mt-8 space-y-3">
                {d.readiness.cards.map((card) => (
                  <li key={card.title} className="border border-brand-line bg-white px-4 py-4">
                    ...
                    <p className="mt-1 text-[14px] font-semibold text-brand-navy">{card.title}</p>
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.readiness.preview} label="Compliance readiness" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Insurance / COI */}
      <section id="sub-insurance" className="scroll-mt-28 border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            <Reveal>
              <h2 className="display-title-light text-3xl sm:text-4xl">{d.insurance.headline}</h2>
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-slate-300">{d.insurance.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.insurance.preview} label="Insurance & COI" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Lien waivers */}
      <section id="sub-liens" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
      ...
      {/* Compliance alerts */}
      <section id="sub-alerts" className="scroll-mt-28 border-b border-brand-line bg-[#EEF2F7]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
      ...
      <section id="sub-controls" className="scroll-mt-28 border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            <Reveal>
      ...
      {/* Explore Compliance & Workforce */}
      <section id="sub-explore" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <Reveal className="max-w-3xl">
            <p className="font-mono text-[11px] font-semibold tracking-[0.16em] text-brand-orange">
              {d.explore.eyebrow}
