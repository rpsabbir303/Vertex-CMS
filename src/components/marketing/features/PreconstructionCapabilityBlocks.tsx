...
import {
  getPreconstructionCapabilityBlocks,
      ...
      <div className="site-shell section-spacing">
        ...
        >
          <Reveal>
            ...
            {block.availabilityNote ? (
              <p className="mt-2 inline-flex rounded-md border border-brand-line bg-white/80 px-2.5 py-1 text-[11px] font-medium text-brand-muted">
                {block.availabilityNote}
              </p>
            ) : null}
...
export function PreconstructionCapabilityBlocks() {
  const blocks = getPreconstructionCapabilityBlocks();
  return (
    <div id="precon-capabilities">
      {blocks.map((block) => (
