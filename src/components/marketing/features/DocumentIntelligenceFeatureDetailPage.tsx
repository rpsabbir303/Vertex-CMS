...
function DiStickyNav() {
  const items = documentIntelligenceFeatureDetail.nav;
  ...
  return (
    <nav
      aria-label="Document Intelligence sections"
...
export function DocumentIntelligenceFeatureDetailPage() {
  const d = documentIntelligenceFeatureDetail;
  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-b border-brand-line/70 bg-[#F7F9FC]">
        ...
        <div className="site-shell relative py-14 sm:py-16 lg:py-20">
          <div className="grid items-center gap-10 lg:grid-cols-[minmax(0,1.05fr)_minmax(0,0.95fr)] lg:gap-14">
            ...
            <Reveal delay={90}>
              <PreviewStage preview={d.hero.preview} label="Document intelligence workspace" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Intro */}
      <section id="di-intro" className="scroll-mt-28 border-b border-brand-line bg-white">
      ...
      <section className="border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            <Reveal>
              <h2 className="display-title-light text-3xl sm:text-4xl">{d.qa.headline}</h2>
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-slate-300">{d.qa.body}</p>
              <ul className="mt-6 space-y-2">
                {d.qa.questions.map((q) => (
                  <li
                    key={q}
                    className="rounded-lg border border-white/10 bg-white/[0.04] px-3 py-2.5 text-[13px] text-slate-300"
                  >
                    &ldquo;{q}&rdquo;
                  </li>
                ))}
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.qa.preview} label="Document Q&A" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="di-summary" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              ...
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-brand-muted">{d.summary.body}</p>
              <ol className="mt-8 space-y-4">
                {d.summary.points.map((p) => (
                  <li key={p.n} className="flex gap-4 border-t border-brand-line pt-4 first:border-t-0 first:pt-0">
                    <p className="font-mono text-[11px] font-bold text-brand-orange">{p.n}</p>
                    <div>
                      <h3 className="text-[14px] font-semibold text-brand-navy">{p.title}</h3>
                      <p className="mt-1 text-[13px] text-brand-muted">{p.body}</p>
                    </div>
                  </li>
                ))}
              </ol>
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.summary.preview} label="AI document summary" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section id="di-extract" className="scroll-mt-28 border-b border-brand-line bg-[#F4F7FB]">
        <div className="site-shell section-spacing">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
              {d.extract.headline}
            </h2>
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.extract.body}</p>
          </Reveal>
          <ul className="mt-10 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
            {d.extract.cards.map((card) => (
          ...
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.extract.preview} label="Information extraction" />
          </Reveal>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-[#061525]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-[minmax(0,0.9fr)_minmax(0,1.1fr)] lg:gap-14">
            <Reveal>
              <h2 className="display-title-light text-3xl sm:text-4xl">{d.compare.headline}</h2>
              <p className="mt-4 max-w-lg text-[15px] leading-relaxed text-slate-300">{d.compare.body}</p>
            </Reveal>
            <Reveal delay={80}>
              <PreviewStage preview={d.compare.preview} label="Revision comparison" dark />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Search & discovery */}
      <section id="di-search" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          <Reveal className="mx-auto max-w-3xl text-center">
            <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
              {d.search.headline}
            </h2>
            <p className="mt-4 text-[15px] leading-relaxed text-brand-muted">{d.search.body}</p>
          </Reveal>
          <Reveal delay={80} className="mt-10">
            <PreviewStage preview={d.search.preview} label="Document search" className="mx-auto max-w-3xl" />
          </Reveal>
        </div>
      </section>

      {/* Connected document context */}
      <section id="di-context" className="scroll-mt-28 border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell section-spacing">
          <div className="grid items-start gap-10 lg:grid-cols-2 lg:gap-14">
            <Reveal>
              <h2 className="font-display text-3xl font-bold tracking-tight text-brand-navy sm:text-4xl">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.context.preview} label="Connected project records" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      <section className="border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
          ...
          <div className="mt-10 grid items-start gap-10 lg:grid-cols-[minmax(0,1fr)_minmax(0,0.75fr)] lg:gap-14">
            ...
            <Reveal delay={80}>
              <PreviewStage preview={d.howItWorks.preview} label="Document workflow" />
            </Reveal>
          </div>
        </div>
      </section>
      ...
      {/* Connected workflows */}
      <section id="di-workflows" className="scroll-mt-28 border-b border-brand-line bg-white">
        <div className="site-shell section-spacing">
