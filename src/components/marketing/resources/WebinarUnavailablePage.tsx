...
export function WebinarUnavailablePage() {
  return (
      ...
      <section className="border-b border-brand-line bg-[#FAFBFD]">
        <div className="site-shell py-14 sm:py-16">
          <div className="max-w-2xl">
            <p className="text-[11px] font-semibold uppercase tracking-[0.16em] text-brand-orange">VertexBuild Webinar</p>
            <h1 className="mt-3 font-display text-[1.85rem] font-bold leading-tight text-brand-navy sm:text-[2.25rem]">
              This webinar is not available
            </h1>
            <p className="mt-5 border-l-2 border-brand-orange pl-4 text-[15px] leading-relaxed text-brand-muted">
              The webinar you requested could not be found, or it is not published yet.
            </p>
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link href={ROUTES.resourcesWebinars} className="btn-primary w-full sm:w-auto">
                Back to Webinars
              </Link>
