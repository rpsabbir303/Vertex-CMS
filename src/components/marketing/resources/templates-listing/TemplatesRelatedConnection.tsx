...
export function TemplatesRelatedConnection() {
  return (
    <section
      id={TEMPLATE_LISTING_PAGE_ANCHORS.connectedResources}
      className="relative scroll-mt-28 border-b border-brand-line/60 bg-white/70"
      aria-labelledby="templates-connected-heading"
    >
      <div className="resource-detail-shell relative z-[1] py-8 sm:py-9 lg:py-10">
        <div className="grid gap-8 lg:grid-cols-[minmax(9rem,11rem)_minmax(0,1fr)] lg:items-start lg:gap-10">
          ...
          <div data-design-layer="content">
            ...
            <h2 id="templates-connected-heading" className="mt-1.5 font-display text-[1.35rem] font-bold tracking-tight text-brand-navy sm:text-[1.5rem]">
              Part of the VertexBuild Resources system
            </h2>
            <p className="mt-2 max-w-xl text-[14px] leading-relaxed text-brand-muted">
              Templates sit alongside guides, blog articles, and webinars — one knowledge system for construction operations.
            </p>
