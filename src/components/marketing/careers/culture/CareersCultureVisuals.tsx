  ...
  return (
    <svg viewBox="0 0 520 380" className="h-auto w-full" fill="none" aria-hidden="true">
      {Array.from({ length: 8 }).map((_, i) => (
        <line key={`g-${i}`} x1="20" y1={40 + i * 42} x2="500" y2={40 + i * 42} stroke="#08233F" strokeOpacity="0.02" />
      ))}
      ...
      <path d="M 56 86 L 92 64 L 124 108 L 78 128 Z" stroke="#08233F" strokeOpacity="0.12" />

      {/* Analysis grid */}
      <rect x="196" y="88" width="128" height="128" rx="1" stroke="#146EF5" strokeOpacity="0.22" />
      <line x1="196" y1="130" x2="324" y2="130" stroke="#146EF5" strokeOpacity="0.12" />
      <line x1="196" y1="172" x2="324" y2="172" stroke="#146EF5" strokeOpacity="0.12" />
      <line x1="238" y1="88" x2="238" y2="216" stroke="#146EF5" strokeOpacity="0.12" />
      <line x1="280" y1="88" x2="280" y2="216" stroke="#146EF5" strokeOpacity="0.12" />
      <circle cx="260" cy="152" r="5" fill="#146EF5" fillOpacity="0.28" className="careers-pulse" />
      <path d="M 255 152 h 10 M 260 147 v 10" stroke="#146EF5" strokeOpacity="0.4" />

      {/* Resolved structure */}
      <rect x="372" y="108" width="108" height="88" rx="1" stroke="#08233F" strokeOpacity="0.16" />
      ...
      <path
        ...
        strokeDasharray="5 7"
      />
      <path d="M 366 148 l 8 4 -8 4" stroke="#FF6A00" strokeOpacity="0.55" />
      ...
      <line x1="48" y1="322" x2="500" y2="322" stroke="#08233F" strokeOpacity="0.08" />
    </svg>
  );
}
...
export function CultureVisualDisciplines() {
  ...
  return (
    <svg viewBox="0 0 520 380" className="h-auto w-full" fill="none" aria-hidden="true">
      <circle cx="260" cy="190" r="118" stroke="#08233F" strokeOpacity="0.05" />
      <circle cx="260" cy="190" r="72" stroke="#146EF5" strokeOpacity="0.1" />
      <circle cx="260" cy="190" r="18" stroke="#146EF5" strokeOpacity="0.22" />
      ...
      {nodes.map((node) => (
        <g key={node.label}>
          <path
            ...
            strokeDasharray="4 8"
          />
          <rect x={node.x - 54} y={node.y - 18} width="108" height="36" rx="1" stroke="#08233F" strokeOpacity="0.18" />
          <text
            x={node.x}
            y={node.y + 4}
            textAnchor="middle"
      ...
      <path d="M 78 190 C 140 90, 380 90, 442 190" stroke="#08233F" strokeOpacity="0.08" />
      <path d="M 78 190 C 140 290, 380 290, 442 190" stroke="#08233F" strokeOpacity="0.08" />
    </svg>
  );
}
...
export function CultureVisualConnectedSystems() {
  ...
  return (
    <svg viewBox="0 0 520 380" className="h-auto w-full" fill="none" aria-hidden="true">
      ...
      <path d="M 254 200 h 12 M 260 194 v 12" stroke="#FFFFFF" strokeOpacity="0.7" />
      ...
      {nodes.map((node) => (
        <g key={node.label}>
          <path
            ...
            strokeDasharray="5 8"
          />
          <rect x={node.x - 52} y={node.y - 16} width="104" height="32" rx="1" stroke="#08233F" strokeOpacity="0.16" />
          <text
            x={node.x}
            y={node.y + 4}
            textAnchor="middle"
      ...
      <path d="M 62 148 H 202 M 318 148 H 458" stroke="#08233F" strokeOpacity="0.08" />
      <path d="M 96 318 C 160 268, 360 268, 424 318" stroke="#08233F" strokeOpacity="0.08" />
    </svg>
  );
}
  ...
  return (
    <svg viewBox="0 0 520 380" className="h-auto w-full" fill="none" aria-hidden="true">
      <path
        ...
        strokeDasharray="6 8"
      />
      <path d="M 56 188 C 140 256, 220 116, 296 188 S 400 280, 468 188" stroke="#08233F" strokeOpacity="0.08" />

      {steps.map((step, i) => (
        <g key={step.label}>
          <circle cx={step.x} cy="188" r="18" stroke={i === 3 ? "#FF6A00" : "#146EF5"} strokeOpacity={i === 3 ? 0.4 : 0.22} />
          <circle
            cx={step.x}
            cy="188"
            r="5"
      ...
      <path d="M 74 188 H 158 M 194 188 H 278 M 314 188 H 398" stroke="#08233F" strokeOpacity="0.1" />

      {/* Origin / destination frames */}
      <rect x="28" y="72" width="88" height="56" rx="1" stroke="#08233F" strokeOpacity="0.12" />
      ...
      <rect x="404" y="72" width="88" height="56" rx="1" stroke="#FF6A00" strokeOpacity="0.28" />
      ...
      <path d="M 72 128 C 72 156, 56 168, 56 170" stroke="#08233F" strokeOpacity="0.12" />
      <path d="M 448 128 C 448 156, 416 168, 416 170" stroke="#FF6A00" strokeOpacity="0.2" />
    </svg>
  );
}
