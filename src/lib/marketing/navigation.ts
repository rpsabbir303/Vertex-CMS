...
export const CTAS = {
  ...
  quote: { label: "Request Quote", href: ROUTES.requestQuote },
  sales: { label: "Contact Sales", href: ROUTES.contact },
...
export const FEATURES_MEGA_MENU: MegaMenuCategory[] = [
  {
    ...
    links: [
      { label: "Projects", href: `${ROUTES.features}#project-management` },
      { label: "Scheduling", href: `${ROUTES.features}#project-management` },
      { label: "Documents", href: `${ROUTES.features}#project-management` },
      { label: "RFIs", href: `${ROUTES.features}#project-management` },
      { label: "Submittals", href: `${ROUTES.features}#project-management` },
      { label: "Change Orders", href: `${ROUTES.features}#project-management` },
    ],
  },
  {
    ...
    links: [
      { label: "Budget & Job Cost", href: `${ROUTES.features}#financial-management` },
      { label: "Native Accounting", href: `${ROUTES.features}#financial-management` },
      { label: "Billing", href: `${ROUTES.features}#financial-management` },
      { label: "AIA Pay Applications", href: `${ROUTES.features}#financial-management` },
      { label: "WIP", href: `${ROUTES.features}#financial-management` },
      { label: "Cash Flow", href: `${ROUTES.features}#financial-management` },
    ],
  },
  {
    id: "field-operations",
    ...
    links: [
      { label: "Daily Logs", href: `${ROUTES.features}#field-operations` },
      { label: "Drawings", href: `${ROUTES.features}#field-operations` },
      { label: "Punch", href: `${ROUTES.features}#field-operations` },
      { label: "T&M", href: `${ROUTES.features}#field-operations` },
      { label: "Safety", href: `${ROUTES.features}#field-operations` },
      { label: "Mobile", href: `${ROUTES.features}#field-operations` },
    ],
  },
  {
    id: "compliance",
    ...
    links: [
      { label: "Subcontractors", href: `${ROUTES.features}#compliance` },
      { label: "Compliance", href: `${ROUTES.features}#compliance` },
      { label: "Workforce", href: `${ROUTES.features}#compliance` },
      { label: "Time", href: `${ROUTES.features}#compliance` },
      { label: "Payroll Readiness", href: `${ROUTES.features}#compliance` },
    ],
  },
  {
    id: "ai",
    ...
    links: [
      { label: "AI Assistant", href: `${ROUTES.features}#ai` },
      { label: "Project Intelligence", href: `${ROUTES.features}#ai` },
      { label: "Predictive Insights", href: `${ROUTES.features}#ai` },
      { label: "Document Intelligence", href: `${ROUTES.features}#ai` },
      { label: "Automation", href: `${ROUTES.features}#ai` },
    ],
  },
  {
    id: "growth",
    ...
    links: [
      { label: "CRM", href: `${ROUTES.features}#growth` },
      { label: "Leads", href: `${ROUTES.features}#growth` },
      { label: "Website Builder", href: `${ROUTES.features}#growth` },
      { label: "Customer Portals", href: `${ROUTES.features}#growth` },
    ],
  },
];
...
export const FOOTER_COLUMNS = {
  ...
  contact: {
    ...
    links: [
      ...
      { label: "Request Quote", href: ROUTES.requestQuote },
